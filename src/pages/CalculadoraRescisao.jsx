    ...
    >
      <div className="w-full max-w-[900px] flex flex-col gap-6">
          ...
          <form className="flex flex-col gap-4">
            ...
            <header className="text-center">
              ...
              <p className="text-gray-600 text-sm font-secondFont">
                Uma ferramenta de estimativa por {infos.name}
              </p>
            </header>
            <h2
        ...
        {/* <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 flex flex-col gap-6 tablet2:gap-0 tablet2:flex-row items-center text-center justify-between">
          ...
          />
          <div className="flex flex-col tablet2:items-start tablet2:w-[55%] ">
            <h2
            ...
            <div className="mt-4 tablet2:text-left w-full text-paragraph3 text-center">
              <p>A_Definir</p>
              <p className="mt-2">A_Definir</p>
              <p className="mt-2">A_Definir</p>

              <div className="flex flex-col justify-center tablet2:justify-start tablet1:flex-row gap-3 mt-4">
                <Button label="Fale no WhatsApp" size="small" />
                <Button
                  label="Envie um E-mail"
                  buttonLink="mailto:A_Definir"
                  size="small"
                />
              </div>
            </div>
